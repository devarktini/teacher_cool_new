    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="relative w-full max-w-xl h-[95%] bg-white rounded-xl shadow-2xl overflow-hidden overflow-y-scroll"
            ...
            >
              ...
              {/* Original Login UI */}
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-6">
