...
export default function PromptBanner() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 py-10 md:py-14">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
        {/* Badge */}
        <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-white text-sm font-medium mb-5">
        ...
        <Link
          href="/prompt-library"
          className="group inline-flex items-center px-7 py-3 bg-white text-blue-600 rounded-xl font-semibold text-base hover:bg-blue-50 transform hover:-translate-y-0.5 transition-all duration-300 shadow-xl hover:shadow-blue-500/25"
        >
