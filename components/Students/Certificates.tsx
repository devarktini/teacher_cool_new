...
const CertificatePreview = React.forwardRef(
  (
    ...
    return (
      <div
        ref={ref}
        className={isPrintMode ? "" : "w-full max-w-4xl mx-auto"}
        style={{
          width: isPrintMode ? "850px" : "100%",
          aspectRatio: "850 / 600",
          maxWidth: isPrintMode ? "850px" : "100%",
          position: "relative",
      ...
      >
        ...
        <div
          style={{
            ...
            justifyContent: "center",
            alignItems: "center",
            padding: isPrintMode ? "60px 80px" : "40px 40px",
            boxSizing: "border-box",
            textAlign: "center",
          }}
        >
          ...
          <div
            style={{
              ...
              lineHeight: isPrintMode ? "1.8" : "1.6",
              color: "#000",
              marginBottom: isPrintMode ? "20px" : "30px",
              fontFamily: "'Roboto', Arial, sans-serif",
              textRendering: "optimizeLegibility",
              WebkitFontSmoothing: "antialiased",
              letterSpacing: isPrintMode ? "0.3px" : "0.1px",
            }}
          >
          ...
          >
            ...
            <p
              style={{
                fontWeight: "700",
                fontSize: isPrintMode ? "18px" : "clamp(14px, 2.5vw, 16px)",
                textRendering: "optimizeLegibility",
                WebkitFontSmoothing: "antialiased",
                letterSpacing: "0.3px",
                color: "#000",
          ...
          <div
            style={{
              position: "absolute",
              bottom: isPrintMode ? "40px" : "20px",
              right: isPrintMode ? "60px" : "30px",
              textAlign: "center",
            }}
          >
            <div
              style={{
                position: "relative",
                width: isPrintMode ? "140px" : "clamp(80px, 20vw, 140px)",
                height: isPrintMode ? "60px" : "clamp(40px, 12vw, 60px)",
                marginBottom: "8px",
              }}
            >
              {signatureImage && (
            ...
            <div
              style={{
                ...
                marginTop: "8px",
                paddingTop: "4px",
                fontSize: isPrintMode ? "12px" : "clamp(10px, 2vw, 12px)",
                fontWeight: "600",
                color: "#000",
                textRendering: "optimizeLegibility",
                WebkitFontSmoothing: "antialiased",
...
const Certificates = () => {
  ...
  const handleDownloadCertificate = async (certificate: any) => {
    ...
    try {
      ...
      // Wait for the hidden component to render with all images loaded
      setTimeout(async () => {
        if (downloadPreviewRef.current) {
          try {
            const canvas = await html2canvas(downloadPreviewRef.current, {
              ...
              onclone: (clonedDoc) => {
                ...
                clonedDoc.querySelectorAll("*").forEach((node: any) => {
                  // Apply text rendering properties
            ...
            // Use A4 size for better standard certificate format
            const pdf = new jsPDF({
  ...
  return (
    <>
      ...
      {showPreview && selectedCertificate && (
        ...
        >
          <div
            className="bg-white rounded shadow-lg w-full max-w-4xl max-h-[90vh] overflow-auto"
          ...
          >
            <div className="p-4 md:p-6">
              <CertificatePreview
                ...
                issueDate={new Date(
                  selectedCertificate.awarded_at
                ).toLocaleDateString()}
                signatureImage={signagture}
                isPrintMode={false}
              />
            </div>
            <div className="flex justify-end gap-3 p-4 border-t bg-gray-50 rounded-b">
              <button
                onClick={() => setShowPreview(false)}
                className="bg-red-500 text-white py-2 px-6 rounded hover:bg-red-600 transition-colors duration-200 font-medium"
              >
                Close
              </button>
            </div>
      ...
      {/* Hidden Preview for Download - Print Mode */}
      {selectedCertificate && (
