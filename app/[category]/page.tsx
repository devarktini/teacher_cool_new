...
export async function generateMetadata({ params }: PageProps) {
    ...
    // get course slug
    const courseSlug = slug.split("-course-in-")[0];

  try {
   
    const slugData = await getSlug(courseSlug);
    ...
    if (courseId) {
      ...
      return {
        ...
        alternates: {
          canonical: `https://www.teachercool.com/courses/${courseSlug}/`,
        },
        openGraph: {
          title: seoTitle,
          description: metaDescription,
          url: `https://www.teachercool.com/courses/${courseSlug}/`,
          type: "website",
        },
      };
    }
...
export default async function Page({ params }: PageProps) {
    ...
    if (!slugData?.course) {
        ...
        return (<CategoryCourses category={categoryName} city = {city} />)
        // return notFoundUI();
    }
